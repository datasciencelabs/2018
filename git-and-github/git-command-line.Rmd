...
that process using git and GitHub through the command line (see the other [tutorial](https://github.com/datasciencelabs/2018/blob/master/git-and-github/git-rstudio.Rmd) for using git and GitHub with RStudio). 
...
> `$ git clone https://github.com/datasciencelabs-students/<your_GitHub_username>-2018HW1.git`
