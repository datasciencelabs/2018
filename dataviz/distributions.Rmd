...
defines the distribution for numerical data. From the plot we can see, for example, that 16.4% of the values are below 66, since $F(66)=$ `r ecdf(heights$height[heights$sex=="Male"])(66)`, or that 84.1% of the values are below 72, since $F(72)=$ `r ecdf(heights$height[heights$sex=="Male"])(72)`, 
...
Note we have to give ET a full summary of our heights and we have not yet summarized female heights. We expect that they will follow a normal distribution, just like males. However, exploratory plots reveal that the approximation is not as useful:
